...
return {
	...
	[1] = {
		id = 1,
		name = "shelf",
		description = "The cold metal of the shelf seeps into the aluminum of your can. A shopper picks you up and gazes at you longingly before setting you down. You are filled with a sense of determination.",
		imagePath = "src/data/images/locations/shelf.png",

		paths = {}, -- No paths, minigame handles exit
